...
def load_sample(inpath, trainpath='sample_train.mat',
    ...
    # reshape
    X_train = train_data.reshape(-1,1,boxsize,boxsize)
    y_train = sample_train['label'].astype('int32')
    y_train = y_train.reshape(numtrain,)
    ...
    # Get validation set
    numval = int(np.floor(numtrain * rate_val))
