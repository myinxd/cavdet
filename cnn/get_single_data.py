...
"""
Get recovered cavity regions from the splited samples, a trick.
"""
...
def main():
    ...
    parser.add_argument("logflag", help="whether to logarithmize the beta function")
    parser.add_argument("thrshold", help="threshold between ext and faint background.")
    ...
    samplepath = os.path.join(obspath, 'sample_sm.mat')
